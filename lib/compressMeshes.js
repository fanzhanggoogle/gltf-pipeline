...
function addCompressionExtensionToPrimitive(gltf, primitive, encodedLen, encodedData) {
    ...
    console.log("Added bufferView " + bufferViewId);
}
...
function compressMeshes(gltf) {
    ForEach.mesh(gltf, function(mesh) {
        ForEach.meshPrimitive(mesh, function(primitive) {
            ...
            addCompressionExtensionToPrimitive(gltf, primitive, encodedLen, encodedData);
