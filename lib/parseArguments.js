...
function parseArguments(args) {
    var argv = yargs
        ...
        .options({
            ...
            'draco.quantizeNormal': {
                describe: 'Quantization bits for normal attribute when using Draco compression. Default is 12.',
                type: 'number'
            },
    ...
    for (i = 0; i < nargs; i++) {
        ...
        if (arg.indexOf('dracoAnimation') >= 0) {
            dracoAnimationOptions = argv.dracoAnimation;
        }
    }
    ...
    return {
        ...
        compressMeshes: argv.d,
        compressAnimations: argv.a,
